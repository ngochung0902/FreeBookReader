...
public class MainData extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBar.setTitle("FreebookReader");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.new_note:
                Intent intent = new Intent(this, Mainthemsach.class);
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            if(arrNotes != null && arrNotes.size() > 0)
            {
                ...
                NoteAdapter adapter = new NoteAdapter(MainData.this,  arrNotes);
                lstNote.setAdapter(adapter);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, Mainxemsach.class);
