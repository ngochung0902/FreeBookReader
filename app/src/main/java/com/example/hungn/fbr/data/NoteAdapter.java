...
public class NoteAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = (View)inflater.inflate(R.layout.layout4, parent, false);
        // find view
        ...
        // set image
        Util.setBitmapToImage(context, Config.FOLDER_IMAGES,model.image, imgAttach);// Config.FOLDER_IMAGES, model.image, imgAttach);
